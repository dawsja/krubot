 ...
 * settings (the AI, the computer, who may sign in) are the
...
export function createApp() {
  ...
  // The apps' sign-in with the provider: the browser outside the app, then the app, before either has a session.
  ...
  // The admin's areas. Reads that everyone needs (a reduced settings
  // view) stay open and are narrowed inside their routes. Skills,
  ...
  app.on(["POST", "PATCH", "PUT", "DELETE"], ["/api/settings"], requireAdmin);
