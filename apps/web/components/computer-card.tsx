...
/*
 * Settings → Team, the admin's: whether the computer is up, what's
 * installed on it, and the Update and Reset buttons. The computer itself
 * is opened from a bot, where the work is, not from Settings; which
 * engine your bots use and its sign-in live in the Engine card. Update
 * pauses the computer, pulls the newest box image from GHCR when the API
 * can reach Docker, patches Debian, Bun and the engines' CLIs in place,
 * and brings the computer back; the phases and the log show here as they
 * happen.
 */
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          The machine every bot works on. Everyone has their own account there, kept through restarts and updates.
        </CardDescription>
        {admin ? (
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <span className="block">Wipes it for everyone, and stops any work running on it.</span>
              <span className="mt-2 block">
                <strong>Gone:</strong> every bot&apos;s files and memory, everyone&apos;s home folder, and anything the bots installed.
              </span>
              <span className="mt-1 block">
                <strong>Kept:</strong> everyone&apos;s AI sign-ins, and your bots, chats, skills and settings, which are kept here, not on the computer.
              </span>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
