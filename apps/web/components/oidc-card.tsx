  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Let other people sign in with your identity provider: Pocket ID, Authentik, Keycloak, Zitadel or any other.</CardDescription>
      ...
      <CardContent className="flex flex-col gap-5">
        <Field>
          ...
          <FieldDescription>Register this as the redirect URL at the provider. It comes from APP_URL, so set that first.</FieldDescription>
        </Field>
        <Field>
          ...
          <FieldDescription>Register this as the sign-out redirect URL. Pocket ID calls it a logout callback URL.</FieldDescription>
        </Field>
        <form onSubmit={save}>
          <FieldGroup className="gap-4">
            ...
            <Field>
              ...
              <FieldDescription>Kru Bot reads its /.well-known/openid-configuration. Pocket ID: the address you open it at.</FieldDescription>
            </Field>
        ...
        {oidc.enabled ? (
          <Alert>
            ...
            <AlertDescription>Everyone gets their own bots, account on the computer and settings. Only this account changes the team&apos;s.</AlertDescription>
          </Alert>
        ) : null}
        <Field orientation="horizontal">
          <FieldContent>
            <FieldTitle>Local sign-in stays</FieldTitle>
            <FieldDescription>Your own account keeps its password, so an outage never locks you out.</FieldDescription>
          </FieldContent>
        </Field>
      </CardContent>
    </Card>
