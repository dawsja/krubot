  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Your connected apps live in your own Composio project, so they are yours alone: nobody else on this Kru Bot sees them or can give them to their bots. Get a free API key at{" "}
          <a href="https://platform.composio.dev" target="_blank" rel="noreferrer" className="text-brand-ink underline underline-offset-2">
          ...
          <form onSubmit={save}>
            <FieldGroup className="gap-4">
              <Field data-invalid={error ? true : undefined}>
                ...
                <FieldDescription>Stored encrypted. It is never shown again, and the bots never see it. A key for a different project disconnects the apps you connected with the old one.</FieldDescription>
      ...
      <AlertDialog open={removing} onOpenChange={setRemoving}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>The apps you connected with it are disconnected here, and your bots lose their tools. They stay in your Composio project if you add the key again.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
