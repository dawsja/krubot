    ...
    <div className={cn("relative flex flex-1 flex-col overflow-y-auto", className)}>
      <Empty className="m-auto max-w-lg px-6 py-10">
        <EmptyHeader className="max-w-md">
          ...
          <EmptyDescription className="text-[14px] leading-6">Message a bot like a teammate. It works on its own computer, keeps context on how you work, and comes back when it needs your approval. Add another when the work grows.</EmptyDescription>
        </EmptyHeader>
